...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("taegeun" + 123); // 정수와의 연산
        System.out.println("taegeun" + 123.456);   // 실수와의 연산
        System.out.println("taegeun" + 'a'); // 문자와의 연산
        System.out.println("taegeun" + true); // 논리값과의 연산
